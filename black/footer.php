				...
				<div class="flex-footer">
					...
					<div class="flex__item">
						...
						<div class="site-footer__section">
							<h4 class="h1 site-footer__section-title">TOP</h4>
							<ul class="site-footer__list">

								<li class="site-footer__list-item"><a href="/">HOME</a></li>

								<li class="site-footer__list-item"><a href="/pages/fleet">OUR FLEET</a></li>
								...
								<li class="site-footer__list-item"><a href="/pages/reserve">RESERVE</a></li>
					...
					<div class="flex__item">
						...
						<div class="site-footer__section">
							...
							<ul class="site-footer__list">
								...
								<li class="site-footer__list-item"><a href="/collections/bentley">Bentley</a></li>

								<li class="site-footer__list-item"><a href="/pages/bmw">BMW</a></li>

								<li class="site-footer__list-item"><a href="/collections/cadillac">Cadillac</a></li>

								<li class="site-footer__list-item"><a href="/collections/ferrari">Ferrari</a></li>

								<li class="site-footer__list-item"><a href="/collections/lamborghini">Lamborghini</a></li>

								<li class="site-footer__list-item"><a href="/pages/mercedes-benz">Mercedes</a></li>

								<li class="site-footer__list-item"><a href="/collections/rolls-royce">Rolls Royce</a></li>

								<li class="site-footer__list-item"><a href="/collections/slingshots">Slingshot</a></li>
					...
					<div class="flex__item">
						...
						<div class="site-footer__section">
							<h4 class="h1 site-footer__section-title">About EMC Rentals</h4>
							<div class="rte-setting">
								<p>The personalized service at <strong>EMC Exotic Rentals</strong> is second to none. We make sure our customers and members are extremely happy with extraordinary vehicles and exceptional personalized 1 to 1 treatments. Our business hours are tailored around the customer experience and we strive to keep the same level of excellence you got each and every time. Everything from the booking process to our chauffeur service is designed with your exclusive experience in mind.</p>
								<p><a href="https://emcexoticsmiami.com/blogs/news" target="_blank" title="Blog">Blog</a></p>
							</div>
						</div>
					...
					<div class="flex__item">
						...
						<div class="site-footer__section">
							...
							<div class="rte-setting">
								<p>Address: 5700 NW 27th St. Miami, FL. 33142</p>
								<p>Phone: +1 (786) 233 - 0693</p>
								<p>Email: Info@emcexoticsmiami.com</p>
						...
						<div class="site-footer__section">
							...
							<div class="form-vertical">
								<form method="post" action="/contact#contact_form" id="contact_form" accept-charset="UTF-8" class="contact-form"><input type="hidden" name="form_type" value="customer"><input type="hidden" name="utf8" value="✓">
									...
									<label for="NewsletterEmail-8e592ec9-f900-46bf-81ee-05732fd5fbd1" class="site-footer__newsletter-label">

										<p>Get notifications when a new car arrives, offers and discounts!</p>

									</label>
									<div class="input-group">
										<input type="email" value="" placeholder="Your email" name="contact[email]" id="NewsletterEmail-8e592ec9-f900-46bf-81ee-05732fd5fbd1" class="input-group__field site-footer__newsletter-input" autocorrect="off" autocapitalize="none">
							...
							<ul class="list--inline payment-icons">
								...
								<li>
									<svg class="icon icon--full-color" width="38" height="24" role="img" aria-labelledby="pi-metapay" viewBox="0 0 38 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<path d="M15.01 9.191h1.138l1.933 3.498 1.934-3.498h1.112v5.747h-.928v-4.405l-1.695 3.05h-.87l-1.696-3.05v4.405h-.927V9.191zm9.023 2.143c-.665 0-1.066.5-1.162 1.12h2.258c-.046-.638-.415-1.12-1.096-1.12zm-2.081 1.474c0-1.305.843-2.254 2.097-2.254 1.234 0 1.971.937 1.971 2.323v.255h-3.148c.111.674.559 1.129 1.28 1.129.576 0 .936-.176 1.277-.497l.493.603c-.465.427-1.055.674-1.803.674-1.358 0-2.167-.99-2.167-2.233zm5.193-1.392h-.854v-.76h.854V9.402h.895v1.256h1.297v.76H28.04v1.924c0 .657.21.89.726.89.236 0 .371-.02.57-.053v.752c-.248.07-.485.102-.742.102-.966 0-1.45-.528-1.45-1.584v-2.032zm5.96.739a1.207 1.207 0 00-1.17-.788c-.766 0-1.256.543-1.256 1.428 0 .863.451 1.433 1.22 1.433.603 0 1.034-.351 1.206-.788v-1.285zM34 14.938h-.878v-.6c-.246.353-.693.703-1.417.703-1.164 0-1.941-.975-1.941-2.246 0-1.283.796-2.241 1.99-2.241.591 0 1.055.236 1.368.653v-.55H34v4.281z" fill="#192830"></path>
										<defs>
