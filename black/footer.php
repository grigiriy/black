<footer>
	<div class="footer-wrapper">
		...
		<div class="col">
			<p class="subheader">Popular brands</p>
			<ul>
		...
		<div class="col">
			<p class="subheader">About EMC Rentals</p>
			<p>The personalized service at EMC Exotic Rentals is second to none. We make sure our customers and members are extremely happy with extraordinary vehicles and exceptional personalized 1 to 1 treatments. Our business hours are tailored around the customer experience and we strive to keep the same level of excellence you got each and every time. Everything from the booking process to our chauffeur service is designed with your exclusive experience in mind.</p>
		</div>

		<div class="col">
			<p class="subheader">Contact info</p>
			<p>Address: 19919191919</p>
			<p>Phone: 19919191919</p>
			<p>Email: 19919191919</p>
			<p>Available 24/7</p>
		</div>

		<div class="col">
			<p class="subheader">Get your discounts</p>
			...
			<form action="">
				...
				<button type="submit">
					<svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-arrow-right" viewBox="0 0 32 32">
						<path d="M7.667 3.795l1.797-1.684L24.334 16 9.464 29.889l-1.797-1.675L20.731 16z"></path>
					</svg>
				</button>
			</form>
		</div>
