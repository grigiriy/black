      ...
      <div class="grid__item small--one-half medium-up--two-thirds small--text-center">
        ...
        <h1 class="site-header__logo" itemscope="" itemtype="http://schema.org/Organization">
          <a href="/" itemprop="url" class="site-header__logo-link">
            <img src="//cdn.shopify.com/s/files/1/0587/6875/2824/files/EMC_RENTALS_LOGO_WHITE_PNG_150x.png?v=1627165194" srcset="//cdn.shopify.com/s/files/1/0587/6875/2824/files/EMC_RENTALS_LOGO_WHITE_PNG_150x.png?v=1627165194 1x, //cdn.shopify.com/s/files/1/0587/6875/2824/files/EMC_RENTALS_LOGO_WHITE_PNG_150x@2x.png?v=1627165194 2x" alt="Emcexoticrentals" itemprop="logo">
          </a>
        </h1>
      </div>
            ...
            <div class="grid__item seven-eighths" id="SiteNavParent">
              ...
              <ul class="site-nav list--inline" id="SiteNav">
                ...
                <li class="site-nav__item">
                  <a href="/pages/fleet" class="site-nav__link">
                    OUR FLEET
                  </a>
                </li>
                ...
                <li class="site-nav__item">
                  <a href="/pages/reserve" class="site-nav__link">
                    RESERVE
                  </a>
                </li>
