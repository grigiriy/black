  ...
  <div class="topline">
    ...
    <button type="button" class="burger" aria-expanded="false">
      <svg aria-hidden="true" focusable="false" role="presentation" viewBox="0 0 32 32">
        <path d="M4.889 14.958h22.222v2.222H4.889v-2.222zM4.889 8.292h22.222v2.222H4.889V8.292zM4.889 21.625h22.222v2.222H4.889v-2.222z"></path>
      </svg>
    </button>
    ...
    <div class="icons">
      ...
      <a href="#">
        <svg aria-hidden="true" focusable="false" role="presentation" viewBox="0 0 31 32">
